/* ============================================================
   C⁰ — The Continuous & the Broken  ·  application logic
   ============================================================ */
(function () {
  'use strict';
  ...
  // ---- store ----
  function loadStore() {
    try { return JSON.parse(localStorage.getItem('continuity_masterbook') || '{}'); }
    catch (e) { return {}; }
  }
  function saveStore() {
    try { localStorage.setItem('continuity_masterbook', JSON.stringify(store)); } catch (e) {}
  }
