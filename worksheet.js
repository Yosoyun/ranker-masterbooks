...
(function () {
  ...
  var css = ''
    ...
    + '.ws-card{background:var(--paper,#fffdf8);color:var(--ink,#1c1a16);width:min(720px,calc(100% - 26px));max-height:92vh;display:flex;flex-direction:column;border-radius:20px;box-shadow:0 30px 80px rgba(0,0,0,.45);border:1px solid var(--line,#e2d8c2);overflow:hidden}'
    + '.ws-hd{padding:20px 24px 14px;border-bottom:1px solid var(--line,#e7decb)}'
    ...
    + '.ws-ft{padding:14px 24px;border-top:1px solid var(--line,#e7decb);display:flex;gap:12px;align-items:center;background:var(--card2,#faf5ea)}'
    ...
    + '.ws-seg button{font:600 13px var(--sans,Inter,sans-serif);padding:9px 14px;border:0;border-right:1px solid var(--line,#e7decb);background:transparent;color:inherit;cursor:pointer;opacity:.6;flex:1;min-width:92px}'
    ...
    + '.ws-chip{font:600 12.5px var(--sans,Inter,sans-serif);padding:7px 12px;border-radius:999px;border:1px solid var(--line2,#d8cdb4);cursor:pointer;opacity:.85;background:var(--card,#fffdf8);transition:.13s}'
    ...
    + '.ws-search{width:100%;box-sizing:border-box;font:inherit;font-size:14px;padding:11px 13px;border:1px solid var(--line2,#d8cdb4);border-radius:11px;background:var(--card,#fffdf8);color:inherit}'
    ...
    + '.ws-ch{border:1px solid var(--line,#e7decb);border-radius:11px;margin:6px 0;overflow:hidden;background:var(--card,#fffdf8)}'
    ...
    + '.ws-card input[type=text],.ws-card input[type=number],.ws-card textarea,.ws-card select{width:100%;box-sizing:border-box;font:inherit;font-size:14px;padding:9px 11px;border:1px solid var(--line2,#d8cdb4);border-radius:9px;background:var(--card,#fffdf8);color:inherit}'
