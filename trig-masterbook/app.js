/* ============================================================
   TRIG — The Circular Arsenal  ·  application logic
   ============================================================ */
(function () {
  'use strict';
  ...
  // ---- store ----
  function loadStore() {
    try { return JSON.parse(localStorage.getItem('trig_masterbook') || '{}'); }
    catch (e) { return {}; }
  }
  function saveStore() {
    try { localStorage.setItem('trig_masterbook', JSON.stringify(store)); } catch (e) {}
  }
  ...
  function renderHome(view){
    ...
    html+='<div class="cover">'
      ...
      + '<h2>TRIG<em>.</em></h2>'
      + '<div class="tagline">One hundred original trigonometry problems where the identity is only half the battle — built for the very top of JEE Advanced and the Olympiad shortlist.</div>'
      ...
      + '<div class="cover-cta">'
        ...
        + '<a class="btn ghost" href="TRIG-Problems.pdf" download>&#8595; Problems PDF</a>'
        + '<a class="btn ghost" href="TRIG-Solutions.pdf" download>&#8595; Solutions PDF</a>'
      + '</div>'
