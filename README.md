...
| **[dy/dx · Solving the Equations of Change](diffeq-masterbook/)** | Formation, order & degree, variables separable, reducible to separable, homogeneous, reducible to homogeneous, linear equations & the integrating factor, initial-value problems, geometric ODEs, growth/decay/cooling/mixing, grand hybrids | 100 |
...
| **[Σ · Patterns, Sums & Limits](sequences-masterbook/)** | AP/GP/HP & means, the AGP & special sums, telescoping & the Vₙ method, sums of powers & figurate numbers, recurrences & characteristic equations, applications of progressions, infinite GP & telescoping series, AM-GM-HM inequalities, greatest term & integer part, grand hybrids | 100 |
| **[(1+x)ⁿ · The Binomial Theorem](binomial-masterbook/)** | The general term, middle & greatest term, coefficient extraction, binomial sums via calculus, the roots-of-unity filter, the multinomial theorem, divisibility & remainders, approximations, the Vandermonde, hockey-stick & Pascal identities, grand hybrids | 100 |
| **[ℙ · Chance & Uncertainty](probability-masterbook/)** | Classical probability & counting, conditioning & independence, total probability & Bayes, Bernoulli trials & the binomial, the binomial's mean/variance/mode, random variables & expectation, inclusion–exclusion, conditioning surprises, grand hybrids | 100 |
| **[n! · The Art of Counting](pnc-masterbook/)** | The two principles, permutations, combinations, circular permutations, stars & bars, inclusion–exclusion & derangements, combinatorial identities, geometric counting, lattice paths, grand hybrids | 100 |
| **[∫ · The Definite Integral](definite-masterbook/)** | Symmetry & parity, the king rule, the limit of a sum, reduction & Wallis, Newton–Leibniz under variable limits, estimation & the MVT, floor & periodic integrands, famous King-rule integrals, elementary improper integrals, grand hybrids | 100 |
| **[ℂ · The Argand Plane](complex-masterbook/)** | The algebra of a+bi, modulus & argument, De Moivre, cube & nth roots of unity, the geometry of the plane, loci, rotation & circles in complex form, triangles & polygons, polynomial equations, grand hybrids | 100 |
