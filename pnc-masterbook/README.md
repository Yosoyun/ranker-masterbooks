...
methods**, and an **Insight** note. Adversarially verified in Python (`sympy`/`numpy`/`itertools`). Run
with `python3 -m http.server 8850` (or open `index.html`). PDFs via `tools/build-pdf.mjs`.
